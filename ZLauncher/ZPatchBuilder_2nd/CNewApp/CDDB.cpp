...
void CDDB::Rendering()
{
	...
	{
		// Copy memory bitmap
		m_pParentDC->BitBlt( 0, 0, m_nWidth, m_nHeight, &m_DC, 0, 0, SRCCOPY);
	}
}
...
**************************************************************/
void CDDB::Rendering( int x, int y, int xSrc, int ySrc, int dxSrc, int dySrc)
{
	...
	{
		// Copy memory bitmap
		m_pParentDC->BitBlt( x, y, dxSrc, dySrc, &m_DC, xSrc, ySrc, SRCCOPY);
	}
}
