...
// Settings of Brazil
#ifdef LOCALE_BRAZIL
#define STR_GUNZ_PROCESS_NAME				"GunzPro"
...
#define STR_ADDRESS_REAL					"patch.gunz.pro"
#define STR_ADDRESS_ALPHA					"127.0.0.1"
...
void CNewAppDlg::GetFileVersion( const char* pszFileName, char* pszVersion)
{
	...
	std::unique_ptr<BYTE> lpBlock(new BYTE[dwLength]);
