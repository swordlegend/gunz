...
//				continue;
			...
			// Checksum
			if ( aPatchNode.GetChildContents( szChecksum, MPTOK_CHECKSUM) == false)
				continue;
			...
			m_pUpdatePatchList.push_back( new ZUpdatePatchNode( szFileName, nSize, strtoul((const char*)szChecksum, NULL, 0)));
		}
